                    ...
                    <section class="content">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                s.invoice_no, 
                                s.added_date,
                                SUM(sp.qty * pp.dealer_price) AS stock_val
                                FROM
                                tbl_stock s 
                                INNER JOIN
                                ...
                                WHERE s.added_by = '".$_SESSION['user_id']."'
                                GROUP BY s.stock_id
                                ORDER BY s.stock_id DESC";
                                $result = mysqli_query($connection->myconn, $query);
                                if (mysqli_num_rows($result) != 0) {
                                    ?>
                                    <table id="view_stock" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center"><?php echo $row['added_date']; ?></td>
                                                    <td style="text-align: right;padding-right: 5px"><?php echo number_format($row['stock_val'],2); ?></td>
                                                    <td style="text-align: center" >
                                                        <img src="../images/view.png" width="15px" height="15px" style="cursor: pointer" onclick="window.open('display_stock.php?stock_id=<?php echo $row['stock_id']; ?>')" />
                                                    </td>
                                                </tr>
                                                <?php
                                            }

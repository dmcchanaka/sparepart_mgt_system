            ...
            <div class="wrapper">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="col-md-2 col-md-offset-5" style="color: red">
                        <?php
                        if (isset($_SESSION['stock_add_msg'])) {
                            echo $_SESSION['stock_add_msg'];
                        }
                        ?>
                    </div>
                    <section class="content">
                        <form action="add_stock.php" type="post" name="stock_form" id="stock_form" onsubmit="return stock_validation();">
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="box box-primary">
                                        ...
                                        <div class="box-body">
                                            <?php
                                            $query_sn = "SELECT COUNT(stock_id) as count FROM tbl_stock";
                                                    ...
                                                    <div class="box box-solid">
                                                        <div class="box-header with-border">
                                                            <div class="form-group">
                                                                <label for="stock_no" class="control-label col-xs-2">Stock No.</label>
                                                                <div class="col-xs-10">
                                                                    <input type="text" class="form-control" id="stock_no" name="stock_no" value="<?php echo $stock_no; ?>" required size="25">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="stock_no" class="control-label col-xs-2">Invoice No.</label>
                                                                <div class="col-xs-10">
                                                                    <input type="text" class="form-control" id="inv_no" name="inv_no" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- /.box-header -->
                                            ...
                                            <table id="stock" class="table table-bordered table-striped">
                                                ...
                                                <tbody id="stock">
                                                    <tr id="tr_1">
                                                        ...
                                                        <td><a onclick="remove_row('1');" style="cursor: pointer"><i class="fa fa-minus"></i></a></td>
                                                    </tr>
                                                </tbody>
                                                <tfoot>
                                                    <tr>
                                        ...
                                        <div class="box-footer">
                                            ...
                                            <button type="button" id="btn_add" class="btn btn-primary" onclick="form_submission('stock_form', 'btn_add')">Submit</button>
                                        </div>
                                        <div class="box-footer">
                                        </div>
                                        <!--</form>-->

                    ...
                    <section class="content">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <?php
                                $query ="SELECT 
                                p.price_id, p.dealer_price,p.retailer_price,b.brand_name, pp.product_name,p.price_status
                                FROM
                                tbl_price p 
                                INNER JOIN 
                                tbl_brand b ON b.brand_id = p.brand_id
                                INNER JOIN
                                tbl_product pp ON pp.product_id = p.product_id
                                ORDER BY b.brand_name, pp.product_name";
...
//                                                ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                        <?php if ($row['price_status'] == '0') { ?>
                                                            <span style="color:green">Active</span>
                                                        <?php } else { ?>
                                                            <span style="color:red">Inactive</span>
                                                        <?php } ?>
                                                    </td>
                                                    <td style="text-align: center" ><?php if ($row['price_status'] == '0') { ?>
                                                            <img src="../images/edit.png" width="15px" height="15px" style="cursor: pointer" onclick="window.open('edit_price.php?price_id=<?php echo $row['price_id']; ?>')" />
                                                        <?php } ?></td>
                                                    <td style="text-align: center" ><?php if ($row['price_status'] == '0') { ?>
                                                            <img src="../images/Recycle_Bin.png" width="20px" height="20px" style="cursor: pointer" onclick="delete_price('<?php echo $row['price_id']; ?>')" />
                                                        <?php } ?></td>
                                                </tr>
                                                <?php
                                            }
                                                                    ...
                                                                    $.ajax({
                                                                        ...
                                                                        success: function (data) {
                                                                            if (userselection == true && data == '1') {
                                                                                alert("Price has been deleted!");
                                                                                location.reload();
                                                                            } else {
                                                                                alert("Price has not been deleted!");
                                                                            }
                                                                        }
                                                                    });
                                                                }

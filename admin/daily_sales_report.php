    ...
    <html>
        ...
        <body class="hold-transition skin-blue fixed sidebar-mini">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" id="cus_id" name="cus_id" value="" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" value="" id="inv_no" name="inv_no" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <script type="text/javascript">
                ...
                function search(){
                    $('#result').load('daily_sales_search.php',{'cus_id':$('#cus_id').val(),'inv_no':$('#inv_no').val(),'fdate':$('#fdate').val(),'tdate':$('#tdate').val()});
                }
            </script>
        </body>
    </html>

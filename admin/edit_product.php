            ...
            <div class="wrapper">
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        <form action="update_product.php" type="post">
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    ...
                                    <div class="box box-primary">
                                        ...
                                        <!--<form role="form">-->
                                        <?php                                           
                                        $query = "SELECT * FROM tbl_product WHERE product_id ='" . $_REQUEST['product_id'] . "'";
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="product_code" name="product_code" value="<?php echo $row['product_code']; ?>" placeholder="Enter Product Code" required>
                                        </div>
                                        <div class="form-group">
